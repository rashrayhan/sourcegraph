 ...
 */
export const ThreadAreaHeader: React.FunctionComponent<Props> = ({ thread, areaURL }) => (
    <div className="thread-header border-top-0 border-bottom simple-area-header">
        <div className="container">
            <h1 className="font-weight-normal mt-3">
                <CheckboxMultipleMarkedOutlineIcon className="icon-inline text-muted small" /> {thread.title}
            </h1>
